        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-1">
            <div className="bg-blue-50 p-6 rounded-lg shadow-md">
              <h3 className="text-2xl font-bold text-blue-800 mb-4">Est. 2014</h3>
              ...
              <h4 className="font-bold text-lg text-blue-800 mb-2">Quick Facts</h4>
          ...
          <div className="lg:col-span-2 space-y-8">
            <section>
              <h2 className="text-3xl font-bold text-blue-800 mb-4">Our Legacy</h2>
            ...
            <section>
              <h2 className="text-3xl font-bold text-blue-800 mb-4">Infrastructure & Safety</h2>
              <p className="text-gray-700 leading-relaxed">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                <div className="bg-white border border-gray-200 p-6 rounded-lg shadow-sm">
                  ...
                  <h3 className="text-xl font-bold text-blue-800 mb-2">Smart Classrooms</h3>
                ...
                <div className="bg-white border border-gray-200 p-6 rounded-lg shadow-sm">
                  ...
                  <h3 className="text-xl font-bold text-blue-800 mb-2">I-Care Program</h3>
                  <p className="text-gray-700">
            ...
            <section>
              <h2 className="text-3xl font-bold text-blue-800 mb-4">Our Unique Approach</h2>
              ...
              <div className="bg-blue-50 p-6 rounded-lg">
                <h3 className="text-xl font-bold text-blue-800 mb-4">Special Programs</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="bg-white p-4 rounded border border-blue-100">
                    <h4 className="font-bold text-blue-800">FLIP</h4>
                    <p className="text-gray-700 text-sm">
                      Enables students to explore their entrepreneurship skills through continuous activities.
                    </p>
                  </div>
                  <div className="bg-white p-4 rounded border border-blue-100">
                    <h4 className="font-bold text-blue-800">DCP</h4>
                    <p className="text-gray-700 text-sm">
