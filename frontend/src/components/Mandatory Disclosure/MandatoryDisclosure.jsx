...
const SchoolPortal = () => {
      ...
      setDocuments([
        {
          ...
          description:
            "Complete results of all classes for the academic year 2023-24",
        ...
        },
        {
          ...
          description:
            "Class X and XII board examination results with analysis",
          updated: "May 20, 2024",
          size: "3.1 MB",
        },
        {
          ...
          description:
            "Complete academic calendar with holidays and exam schedules",
  ...
  const handleDownload = (documentId) => {
    ...
    window.open(
      `http://localhost:3000/api/pdfDownload?id=${documentId}`,
      "_blank"
    );
  };
          ...
          <div className="col-span-1 border rounded-lg p-6">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="font-medium">3330519</p>
              </div>

              <div>
                <h3 className="text-sm text-gray-500">Address</h3>
                <p className="font-medium">
                  Main Road, Near Over Bridge Uslapur, Bilaspur C.G., Bilaspur
          ...
          <div className="col-span-1 md:col-span-2 space-y-4">
              ...
              {expandedSection === "infrastructure" && (
                <div className="p-4 border-t space-y-4">
                  <div>
                    ...
                    <p className="font-medium">6179.83</p>
                  </div>
                  <div>
                    <h3 className="text-sm text-gray-500">
                      No and Size of the Class Room(In SQ.MTR) :
                    </h3>
                    <p className="font-medium">30 (Size 10.50x5.50</p>
                  </div>
                  <div>
                    <h3 className="text-sm text-gray-500">
                      No and Size of Laboratories including Compurter Labs (In
                      SQ.MTR)
                    </h3>
                    <p className="font-medium">5 labs, 299.25</p>
                  </div>
                  <div>
                    <h3 className="text-sm text-gray-500">
            ...
            <div className="border rounded-lg">
              ...
              >
                ...
                <svg
                  className={`w-5 h-5 transition-transform ${
                    expandedSection === "academic" ? "rotate-180" : ""
                  }`}
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
              ...
              {expandedSection === "academic" && (
                <div className="p-4 border-t">
                  <p className="text-gray-600">
                    Academic information would appear here.
                  </p>
                </div>
              )}
            </div>
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-center">
                  ...
                  <div className="flex items-center">
                    ...
                    <span className="bg-gray-900 text-white px-2 py-0.5 text-xs rounded-full">
                      Current
                    </span>
                  </div>
                </div>
